...
public class ThongKeModule_NhanVien {
    ...
    public static JPanel getThongKeNhanVienGUI() {
        ...
        JPanel card_4 = new dashboardCard_2("Khác", Integer.toString(tk.getSoLuongNhanVien()-tk.getSoLuongNhanVien_ChucVu("Thủ Thư")-tk.getSoLuongNhanVien_ChucVu("Quản Lý Kho")), "../../images/output-onlinepngtools - 2020-06-05T084549.737.png").getdashboardCard();
        ...
        JPanel card_2 = new dashboardCard_2("Quản Lý Kho", Integer.toString(tk.getSoLuongNhanVien_ChucVu("Quản Lý Kho")), "../../images/output-onlinepngtools - 2020-06-05T084602.595.png").getdashboardCard();
        ...
        value.add(tk.getSoLuongNhanVien()-tk.getSoLuongNhanVien_ChucVu("Thủ Thư")-tk.getSoLuongNhanVien_ChucVu("Quản Lý Kho"));
