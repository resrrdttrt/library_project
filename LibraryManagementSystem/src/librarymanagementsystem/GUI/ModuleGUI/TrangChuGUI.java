...
public class TrangChuGUI extends javax.swing.JFrame {
    ...
    public static JPanel getTrangChuGUI() {
        ...
        int value_2 = khachHangBUS.getSoLuongKhachHang();
        ...
        JPanel card_2 = new dashboardCard("KHÁCH HÀNG", Integer.toString(value_2), "../../images/output-onlinepngtools (86).png").getdashboardCard();
        ...
        JPanel chart_1 = chart.lineChart("Biểu Đồ về Sách Mượn (2024)", "số sách mượn/tháng", "tháng", "số sách mượn", value, name_value);
        ...
        name_value2.add("Nhóm người dưới 19 tuổi");
        name_value2.add("Nhóm người từ 19 đến 49 tuổi");
        name_value2.add("Nhóm người trên 49 tuổi");
