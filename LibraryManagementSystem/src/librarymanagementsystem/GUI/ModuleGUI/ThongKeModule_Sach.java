...
public class ThongKeModule_Sach {
    ...
    public static JPanel getTrangChuGUI() {
        ...
        JPanel card_1 = new dashboardCard_2("Thể Loại", Integer.toString(tk.soLuong_Sach_TheLoai()), "../../images/output-onlinepngtools - 2020-06-05T084549.737.png").getdashboardCard();
        JPanel card_2 = new dashboardCard_2("Sách Việt Nam", Integer.toString(tk.soLuong_Sach_NgonNgu("Tiếng Việt")), "../../images/output-onlinepngtools - 2020-06-05T084557.140.png").getdashboardCard();
        JPanel card_3 = new dashboardCard_2("Sách Nước Ngoài", Integer.toString(tk.soLuong_Sach_NgonNgu("Tiếng Anh")), "../../images/output-onlinepngtools - 2020-06-05T084602.595.png").getdashboardCard();
