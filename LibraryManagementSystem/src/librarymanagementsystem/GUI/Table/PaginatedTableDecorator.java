            ...
            public void mouseClicked(MouseEvent event){
                if(event.getClickCount()== 1 && SwingUtilities.isRightMouseButton(event)){ // Chuột Phải
                    ...
                    RowPopup rp = new RowPopup(){
                        @Override
                        public void viewActionPerformed(String pKey, ActionEvent e){
                            JOptionPane.showMessageDialog(null, "Phieu Muon " + pKey + " Xem Chi Tiết");
                        }
                        @Override
                        public void editActionPerformed(String pKey, ActionEvent e){
                            JOptionPane.showMessageDialog(null, "Phieu Muon " + pKey + " Sửa");
                            new SuaLoaiSachForm(pKey).setVisible(true);
                        }
                        @Override
                        public void deleteActionPerformed(String pKey, ActionEvent e){
            ...
            public void mouseClicked(MouseEvent event){
                if(event.getClickCount()== 1 && SwingUtilities.isRightMouseButton(event)){ // Chuột Phải
                    ...
                    RowPopup rp = new RowPopup(){
                        @Override
                        public void viewActionPerformed(String pKey, ActionEvent e){
                            JOptionPane.showMessageDialog(null, "Kho Sach " + pKey + " Xem Chi Tiết");
                        }
                        @Override
                        public void editActionPerformed(String pKey, ActionEvent e){
                            JOptionPane.showMessageDialog(null, "Kho Sach " + pKey + " Sửa");
                            new SuaLoaiSachForm(pKey).setVisible(true);
                        }
                        @Override
                        public void deleteActionPerformed(String pKey, ActionEvent e){
            ...
            public void mouseClicked(MouseEvent event){
                if(event.getClickCount()== 1 && SwingUtilities.isRightMouseButton(event)){ // Chuột Phải
                    ...
                    RowPopup rp = new RowPopup(){
                        @Override
                        public void viewActionPerformed(String pKey, ActionEvent e){
                            JOptionPane.showMessageDialog(null, "Khach Hang " + pKey + " Xem Chi Tiết");
                        }
                        @Override
                        public void editActionPerformed(String pKey, ActionEvent e){
                            JOptionPane.showMessageDialog(null, "Khach Hang " + pKey + " Sửa");
            ...
            public void mouseClicked(MouseEvent event){
                if(event.getClickCount()== 1 && SwingUtilities.isRightMouseButton(event)){ // Chuột Phải
                    ...
                    RowPopup rp = new RowPopup(){
                        @Override
                        public void viewActionPerformed(String pKey, ActionEvent e){
                            JOptionPane.showMessageDialog(null, "Quyen " + pKey + " Xem Chi Tiết");
                        }
                        @Override
                        public void editActionPerformed(String pKey, ActionEvent e){
                            JOptionPane.showMessageDialog(null, "Quyen " + pKey + " Sửa");
//                            new SuaLoaiSachForm(pKey).setVisible(true);
                        }
                        @Override
                        public void deleteActionPerformed(String pKey, ActionEvent e){
            ...
            public void mouseClicked(MouseEvent event){
                if(event.getClickCount()== 1 && SwingUtilities.isRightMouseButton(event)){ // Chuột Phải
                    ...
                    RowPopup rp = new RowPopup(){
                        @Override
                        public void viewActionPerformed(String pKey, ActionEvent e){
                            JOptionPane.showMessageDialog(null, "Admin " + pKey + " Xem Chi Tiết");
                        }
                        @Override
                        public void editActionPerformed(String pKey, ActionEvent e){
                            JOptionPane.showMessageDialog(null, "Admin " + pKey + " Sửa");
            ...
            public void mouseClicked(MouseEvent event){
                if(event.getClickCount()== 1 && SwingUtilities.isRightMouseButton(event)){ // Chuột Phải
                    ...
                    RowPopup rp = new RowPopup(){
                        @Override
                        public void viewActionPerformed(String pKey, ActionEvent e){
                            JOptionPane.showMessageDialog(null, "Phieu Xuat " + pKey + " Xem Chi Tiết");
                        }
                        @Override
                        public void editActionPerformed(String pKey, ActionEvent e){
                            JOptionPane.showMessageDialog(null, "Phieu Xuat " + pKey + " Sửa");
            ...
            public void mouseClicked(MouseEvent event){
                if(event.getClickCount()== 1 && SwingUtilities.isRightMouseButton(event)){ // Chuột Phải
                    ...
                    RowPopup rp = new RowPopup(){
                        @Override
                        public void viewActionPerformed(String pKey, ActionEvent e){
                            JOptionPane.showMessageDialog(null, "Phieu Nhap " + pKey + " Xem Chi Tiết");
                        }
                        @Override
                        public void editActionPerformed(String pKey, ActionEvent e){
                            JOptionPane.showMessageDialog(null, "Phieu Nhap " + pKey + " Sửa");
//                            new SuaLoaiSachForm(pKey).setVisible(true);
                        }
                        @Override
                        public void deleteActionPerformed(String pKey, ActionEvent e){
            ...
            public void mouseClicked(MouseEvent event){
                if(event.getClickCount()== 1 && SwingUtilities.isRightMouseButton(event)){ // Chuột Phải
                    ...
                    RowPopup rp = new RowPopup(){
                        @Override
                        public void viewActionPerformed(String pKey, ActionEvent e){
                            JOptionPane.showMessageDialog(null, "Phieu Phat " + pKey + " Xem Chi Tiết");
                        }
                        @Override
                        public void editActionPerformed(String pKey, ActionEvent e){
                            JOptionPane.showMessageDialog(null, "Phieu Phat " + pKey + " Sửa");
            ...
            public void mouseClicked(MouseEvent event){
                if(event.getClickCount()== 1 && SwingUtilities.isRightMouseButton(event)){ // Chuột Phải
                    ...
                    RowPopup rp = new RowPopup(){
                        @Override
                        public void viewActionPerformed(String pKey, ActionEvent e){
                            JOptionPane.showMessageDialog(null, "LD Phat " + pKey + " Xem Chi Tiết");
                        }
                        @Override
                        public void editActionPerformed(String pKey, ActionEvent e){
                            JOptionPane.showMessageDialog(null, "LD Phat " + pKey + " Sửa");
