...
public class LoginGUI extends JFrame{
    ...
    private void initComponents() {
        ...
        URL imageUrl = getClass().getResource("../images/login3.png");
        if (imageUrl != null) {
            login_form.setIcon(new javax.swing.ImageIcon(imageUrl));
        } else {
            // Handle missing image (for now, just print a message)
            System.out.println("Image not found: ../images/login3.png");
        }
    ...
    public Boolean kiemTraDangNhap(){
        ...
        if (!nhanvien.equals("")){
            current_session = tknhanvien.getNhanVien(nhanvien).getHoTen();
            return true;
        }
