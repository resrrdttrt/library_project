...
public class AlertGUI extends javax.swing.JFrame{
    ...
    public AlertGUI(int choices, String title, String alert, String choice_1, String choice_2) {
        String image = "";
        switch (choices) {
            case 0:
                // Câu Hỏi
    ...
    public void setProperties(int choices, String title, String alert, String choice_1, String choice_2){
        String image = "";
        switch (choices) {
            case 0:
                // Câu Hỏi
